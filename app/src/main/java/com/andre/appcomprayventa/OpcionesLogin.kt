...
import com.andre.appcomprayventa.Opciones_login.Login_Email
import com.andre.appcomprayventa.databinding.ActivityOpcionesLoginBinding
...
class OpcionesLogin : AppCompatActivity() {
    ...
    private fun autenticacionGoogle(idToken: String?) {
        ...
        firebaseAuth.signInWithCredential(credential)
            .addOnSuccessListener { resulatsoAuth ->
                if(resulatsoAuth.additionalUserInfo!!.isNewUser){
                    llenarInfoBD()
                } else{
