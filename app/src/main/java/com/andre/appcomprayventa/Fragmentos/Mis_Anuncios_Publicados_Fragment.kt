...
import com.andre.appcomprayventa.databinding.FragmentMisAnunciosBinding
import com.andre.appcomprayventa.databinding.FragmentMisAnunciosPublicadosBinding
...
class Mis_Anuncios_Publicados_Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.IbLimpiar.setOnClickListener {
            val consulta = binding.EtBuscar.toString().trim()
